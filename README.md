...
- **الغابة**: مشهد ثلاثي الأبعاد (WebGL) فيه 486 شجرة (بالقاعدة الافتراضية) موزّعة على بساتين بحسب الحرف الأول، على أرض متموّجة
...
- **الأرقام**: 1651 جذرًا (منها 941 ورد منه فعل)، 1470 فعلًا قرآنيًا في 19353 موضعًا، 3163 مشتقًّا اسميًا، 6236 آية؛
  و7967 فعلًا في المعاجم منها 6497 لم ترد في القرآن.
