    ...
    <>
      ...
      {hover && (
        <div className="tip" style={{ left: hover.x, top: hover.y }}>
          ...
          <div className="stats">
            {plural(hover.tree.bi.roots.length, 'جذر واحد', 'جذران', 'جذور', 'جذرًا')} · {plural(hover.tree.bi.verbLemmas, 'فعل واحد', 'فعلان', 'أفعال', 'فعلًا')} في القرآن · {plural(hover.tree.bi.verbTokens, 'موضع واحد', 'موضعان', 'مواضع', 'موضعًا')}
          </div>
          {hover.tree.bi.otherVerbs > 0 && (
            <div className="stats">+ {plural(hover.tree.bi.otherVerbs, 'فعل واحد', 'فعلان', 'أفعال', 'فعلًا')} من المعاجم خارج القرآن</div>
          )}
        </div>
      )}
